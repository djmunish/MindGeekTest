...
class SceneDelegate: UIResponder, UIWindowSceneDelegate {
    ...
    func sceneDidEnterBackground(_ scene: UIScene) {
        ...
        if  passcodeState == .active {
            let rc = UIApplication.shared.windows[0].rootViewController as! UINavigationController
            let vc = rc.viewControllers[0] as? ViewController
            vc?.openPassCodeController()
        }
